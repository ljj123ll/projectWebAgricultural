...
('农家土鸡蛋 30枚', @merchant_id2, 4, 45.0, 120, 'https://via.placeholder.com/300x300/e6a23c/fff?text=Eggs', '绵阳市三台', 1, 89, 4.8),
('安岳柠檬 5斤装', @merchant_id1, 1, 19.9, 500, 'https://via.placeholder.com/300x300/f56c6c/fff?text=Lemon', '资阳市安岳', 1, 230, 4.7),
('通江银耳 特级', @merchant_id2, 3, 88.0, 45, 'https://via.placeholder.com/300x300/409eff/fff?text=Fungus', '巴中市通江', 1, 67, 5.0);
